...
from baseline_conditions_Order_DL_sequence_unbound import *
                ...
                if ls_random:
                    ...
                    for edgex in treex.edges:
                        if not edgex[0]==root:
                            ...
                            results1 = open('DL_controlled_RLA_unbounded_crossings_results.csv','a')
                    ...
                    for edgey in tree.edges:
                        if not edgey[0]==0:
                            ...
                            results2 = open('DL_controlled_RLA_unbounded_crossings_results.csv','a')
