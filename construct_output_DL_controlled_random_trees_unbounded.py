...
from baseline_conditions_nCross_DL_sequence_unbound import *
                ...
                if ls_random:
                    ...
                    for edgex in treex.edges:
                        if not edgex[0]==root:
                            ...
                            results1 = open('DL-controlled_Random_structures_with_unbound_crossings.csv','a')
                            results1.write(str(lang)+"\t"+"random"+"\t"+str(sent_id)+"\t"+str(n)+"\t"+str(max_arity_rand)+"\t"+str(avg_arity_rand)+"\t"+str(projection_degree_rand)+"\t"+str(gap_degree_rand)+"\t"+str(k_illnest_rand)+"\t"+str(edgex)+"\t"+str(direction_rand)+"\t"+str(dep_distance_rand)+"\t"+str(projectivity_rand)+"\t"+str(edge_degree_rand)+"\t"+str(endpoint_cross_rand)+"\t"+str(HDD_rand)+"\n")
                            results1.close()
                    ...
                    for edgey in tree.edges:
                        if not edgey[0]==0:
                            ...
                            results2 = open('DL-controlled_Random_structures_with_unbound_crossings.csv','a')
                            results2.write(str(lang)+"\t"+"real"+"\t"+str(sent_id)+"\t"+str(n)+"\t"+str(max_arity_real)+"\t"+str(avg_arity_real)+"\t"+str(projection_degree_real)+"\t"+str(gap_degree_real)+"\t"+str(k_illnest_real)+"\t"+str(edgey)+"\t"+str(direction_real)+"\t"+str(dep_distance_real)+"\t"+str(projectivity_real)+"\t"+str(edge_degree_real)+"\t"+str(endpoint_cross_real)+"\t"+str(HDD_real)+"\n")
                            results2.close()
                    print("\n-----------------\n"+str(tree.edges))
