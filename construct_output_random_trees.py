...
from baseline_conditions_nCross import *
                ...
                if ls_random:
                    ...
                    for edgex in treex.edges:
                        if not edgex[0]==root:
                            ...
                            results1 = open('Random_structures_baseline_results_SUD.csv','a')
                    ...
                    for edgey in tree.edges:
                        if not edgey[0]==0:
                            ...
                            results2 = open('Random_structures_baseline_results_SUD.csv','a')
